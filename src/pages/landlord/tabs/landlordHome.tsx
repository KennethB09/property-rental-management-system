...
export default function LandlordHome() {
  ...
  return (
    <div className="flex flex-col font-roboto p-4 h-full gap-4">
      <header className="">
        <h1 className="font-bold text-3xl text-gray-900">Home</h1>
      </header>
      <div className="flex justify-between items-center gap-3">
        <div className="aspect-square border-2 border-gray-400 w-full rounded-2xl p-3 flex flex-col items-center justify-start gap-3">
      ...
      <div className="border-2 border-gray-400 rounded-[10px] h-full p-3">
        ...
        <div className="mt-2 h-full flex flex-col gap-1 overflow-y-scroll">
          {properties.length !== 0 ? (
