...
export default function ListingItem({ property, onClick }: ListingItemProps) {
  ...
  return (
    <div
      className="overflow-clip relative h-88 aspect-square items-center justify-center bg-gray-900 flex flex-col rounded-2xl border-1 border-gray-400"
    ...
    >
      <button
        ...
        onClick={handleSave}
      >
        {isSave ? <Heart size={25} fill="oklch(52.7% 0.154 150.069)" stroke="0"/> : <Heart size={25} />}
      </button>
